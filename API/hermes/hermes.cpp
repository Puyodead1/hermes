...
jsi::Value HermesRuntimeImpl::evaluateJavaScript(
  ...
  if (isMainBundle) {
    ...
    ::hermes::hermesLog("AliuHermes", "Modifying GLOBAL_ENV");
    // evaluateJavaScript(
    ...
    evaluateJavaScript(
        // TODO move bootstrap to this repo and call it with cmake?
        std::make_unique<jsi::StringBuffer>(std::string("(()=>{function n(n,o,t,r,i,c,u){try{var e=n[c](u),l=e.value}catch(a){t(a);return}e.done?o(l):Promise.resolve(l).then(r,i)}function o(o){return function(){var t=this,r=arguments;return new Promise(function(i,c){var u=o.apply(t,r);function e(o){n(u,i,c,e,l,'next',o)}function l(o){n(u,i,c,e,l,'throw',o)}e(void 0)})}}o(function*(){window.GLOBAL_ENV.API_ENDPOINT='//biscord.lol/api',window.GLOBAL_ENV.GATEWAY_ENDPOINT='wss://biscord.lol',window.location.host='biscord.lol'})()})();")),
        "bootstrap"
    );
  }
