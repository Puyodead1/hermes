...
jsi::Value HermesRuntimeImpl::evaluateJavaScript(
  ...
  if (isMainBundle) {
    ...
    evaluateJavaScript(
        ...
        std::make_unique<jsi::StringBuffer>(std::string("(()=>{function o(o,e,t,r,i,n,l){try{var a=o[n](l),s=a.value}catch(c){t(c);return}a.done?e(s):Promise.resolve(s).then(r,i)}function e(e){return function(){var t=this,r=arguments;return new Promise(function(i,n){var l=e.apply(t,r);function a(e){o(l,i,n,a,s,'next',e)}function s(e){o(l,i,n,a,s,'throw',e)}a(void 0)})}}e(function*(){window.GLOBAL_ENV.API_ENDPOINT='//biscord.lol/api',window.GLOBAL_ENV.GATEWAY_ENDPOINT='wss://biscord.lol',window.location.host='biscord.lol';var{externalStorageDirectory:o,requestPermissions:e,download:t,checkPermissions:r}=nativeModuleProxy.AliucordNative;try{var i=yield r(),n=nativeModuleProxy.DialogManagerAndroid.getConstants();if(!i&&!((yield new Promise((o,e)=>{nativeModuleProxy.DialogManagerAndroid.showAlert({title:'Storage Permissions',message:'Aliucord needs access to your storage to load plugins and themes.',cancelable:!0,buttonPositive:'Ok',buttonNegative:'Cancel'},e,(e,t)=>{e===n.buttonClicked&&t===n.buttonPositive?o(!0):o(!1)})}))&&(yield e()))){nativeModuleProxy.DialogManagerAndroid.showAlert({title:'Storage Permissions',message:'Access to your storage is required for aliucord to load.',cancelable:!0,buttonPositive:'Ok'},()=>null,()=>null);return}var l=o+'/AliucordRN';AliuFS.mkdir(l);var a=l+'/Aliucord.js.bundle';AliuFS.exists(a)||(yield t('https://raw.githubusercontent.com/Aliucord/AliucordRN/builds/Aliucord.js.bundle',a)),globalThis.aliucord=AliuHermes.run(a)}catch(s){nativeModuleProxy.DialogManagerAndroid.showAlert({title:'Error',message:'Something went wrong while loading aliucord, check logs for the specific error.',cancelable:!0,buttonPositive:'Ok'},()=>null,()=>null),console.error(s.stack)}})()})();")),
        "bootstrap"
    );
  }
